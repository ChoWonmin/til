...
int main(void){
    ...
    while ( !glfwWindowShouldClose( window ) ) {
        ...
        glm::vec3 cameraPosition = glm::rotate(-camYaw*PI/180, glm::vec3(0,1,0))
            * glm::rotate(-camPitch*PI/180, glm::vec3(1,0,0)) * glm::vec4(0,0,5,0);;
        
        glm::mat4 viewMat = lookAt( cameraPosition,glm::vec3(0,0,0),glm::vec3(0,1,0));
